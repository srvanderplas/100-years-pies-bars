...
[However, guidance to favor bar charts over pie charts still shows up in statistical literature -- cite @fienbergGraphicalMethodsStatistics1979, @haemerPseudoThirdDimension1951, @haemerPresentationProblemsSuiting1949, @nisselson1978graphic. It almost seems like approximately once every 20 years people think about graphics, decry the state of the field, and call for a better set of empirical guidelines!]{.svp}
