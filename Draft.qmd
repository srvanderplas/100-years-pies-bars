...
~~resolve this issue~~ 
[determine which chart is more effective]{.svp}, but no single consensus has emerged[, even after 100 years of experimentation]{.svp}.
In this paper, we 
~~will provide a comprehensive summary of the existing literature~~ 
[assess the existing literature and attempt to reconcile experiments with diverging results]{.svp}. 
...
William Playfair introduced the pie and bar charts in the early 1800s, [This is demonstrably false -- https://www.anychart.com/blog/2015/06/02/first-bar-chart-in-history/, at least for bar charts.]{.svp} and by the turn of the next century, strong opinions about the effectiveness of alternative displays of the same data had been publicized in textbooks and manuals.
...
[Approximately 55 years after the original sequence of experiments,]{.svp} @clevelandGraphicalPerceptionTheory1984, a statistician and a psychologist by training, respectively, conducted experiments on simple graphical elements.
...
The later studies show that the [1980-1990s experiments were]{.svp} more of an interdisciplinary conversation around data displays, [reflecting the fact that statistical graphics had]{.svp} become a [more]{.svp} general [scientific]{.svp} tool [and were no longer]{.svp} limited to statisticians.
...
>>>>>>> baee5e1346c30603f25385d9ffc2feae9e5f6487
